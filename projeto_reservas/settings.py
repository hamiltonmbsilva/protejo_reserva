"""
Django settings for projeto_reservas project.
...
SECRET_KEY = 'django-insecure-u+w9h&vzdlh0iu#qxsv_&*ku58tb7yexj#)p8qpfzi3d^9yv)b'
...
ROOT_URLCONF = 'projeto_reservas.urls'
...
WSGI_APPLICATION = 'projeto_reservas.wsgi.application'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'static_root') # Adicione esta linha
...
JAZZMIN_SETTINGS = {
    ...
    # Opcional: Adicionar um logo à navegação
